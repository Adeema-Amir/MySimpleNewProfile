      ...
      <div className="max-w-5xl mx-auto flex flex-wrap p-5 flex-col md:flex-row">
        ...
        >
          <div className="md:ml-auto md:mr-auto font-4 pt-1 md:pl-14 pl-1 flex flex-wrap items-center md:text-base text-1xl md:justify-center justify-items-start">
            <a href="#team" className="mr-11 pr-2 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              About
            </a>
                ...
                <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
                  <div className="relative grid gap-6 bg-black px-2 py-6 sm:gap-8 ">
                    ...
                    >
                      <div className="ml-4">
                        <p className="text-base font-medium text-white">
                          <a href="#skills">ADEEMA TEMPLATE #1</a>
                        </p>
                    ...
                    >
                      <div className="ml-4">
                        <p className="text-base font-medium text-white">
                        <a href="#skills">ADEEMA TEMPLATE #2</a>
                        </p>
                        <p className="mt-1 text-sm text-gray-500">
                          Second Template
                        </p>
            ...
            <a href="#profile" className="mr-12 md:ml-11 ml-0 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Product
            </a>
            <a href="#newsletter" className="mr-5 cursor-pointer text-gray-300 hover:text-white font-semibold tr04">
              Contact
            </a>
          </div>
          <a
