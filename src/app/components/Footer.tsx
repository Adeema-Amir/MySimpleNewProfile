          ...
          <li className="space-y-5">
            ...
            <ul className="space-y-4">
              <li>
                <a
                  className="hover:text-white transition-colors duration-200 text-xl"
                  href="https://twitter.com/AmirAdeema"
                >
                  <img className="w-10" src="twitter.png" alt="Twitter" />
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <img className="w-10" src="facebook.png" alt="Facebook" />
                </a>
              </li>
              <li>
                <a
                ...
                >
                  <img className="w-10" src="instagram.png" alt="Instagram" />
                </a>
              </li>
            </ul>
          </li>
